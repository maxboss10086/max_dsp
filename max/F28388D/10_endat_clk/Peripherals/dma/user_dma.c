...
void init_dma_5(){
    ...
    DMA_configAddresses(DMA_CH5_BASE, (uint16_t *)(dma_5 + SPI_O_TXBUF),spib_sData);
    ...
    DMA_configMode(DMA_CH5_BASE, dma_5_TRIGGER, DMA_CFG_ONESHOT_DISABLE |
...
void init_dma_6(){
   dma_6_interrupt_en();
    ...
    DMA_configMode(DMA_CH6_BASE, dma_6_TRIGGER, DMA_CFG_ONESHOT_DISABLE |
                   DMA_CFG_CONTINUOUS_ENABLE | DMA_CFG_SIZE_16BIT);
    //传输完毕触发DMA中断
