MEMORY
{
   ...
   ECATSS_CONFIG  : origin = 0x00057F00, length = 0x00000100
   ECATSS         : origin = 0x00057E00, length = 0x00000100
   ...
   CPU1TOCPU2_IPC_CPU1VIEW : origin = 0x0005CE00, length = 0x00000040
   CPU1TOCM_IPC_CPU1VIEW   : origin = 0x0005CE40, length = 0x00000040

   MCAN_ERROR            : origin = 0x0005C800, length = 0x00000400
   MCAN                  : origin = 0x0005C600, length = 0x00000200
   MCANSS                : origin = 0x0005C400, length = 0x00000040

   ROMPREFETCH  : origin = 0x05F588, length = 0x000008
   ...
   EMIF2CONFIG  : origin = 0x05F4E0, length = 0x000020     /* Emif-2 Config registers */
   ...
   ROMWAITSTATE : origin = 0x05F580, length = 0x000008     /* ROM Config registers */
   ...
   CM_CONF      : origin = 0x05DC00, length = 0x000400
...
/*** PIE Vect Table and Boot ROM Variables Structures ***/
  UNION run = PIE_VECT_TABLE
   ...
   EcatssConfigRegsFile       : > ECATSS_CONFIG, type=NOINIT
   EcatssRegsFile             : > ECATSS, type=NOINIT
   ...
   IpcRegsCPUFile           : > CPU1TOCPU2_IPC_CPU1VIEW, type=NOINIT
   IpcRegsCMFile            : > CPU1TOCM_IPC_CPU1VIEW, type=NOINIT


   McanErrorRegsFile          : > MCAN_ERROR, type=NOINIT
   ...
   TestErrorRegsFile          : > TEST_ERROR, type=NOINIT
   ...
   CmConfRegsFile        : > CM_CONF, type=NOINIT
