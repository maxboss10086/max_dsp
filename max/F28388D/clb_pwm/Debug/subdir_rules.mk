...
syscfg/clb_config.h: build-1670253503 ../empty.syscfg
syscfg/clb_config.c: build-1670253503
syscfg/clb.dot: build-1670253503
syscfg/clb_sim.cpp: build-1670253503
syscfg/: build-1670253503

syscfg/%.obj: ./syscfg/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C2000 Compiler'
	"C:/TI/ccs10.1/ccs/tools/compiler/ti-cgt-c2000_20.2.1.LTS/bin/cl2000" -v28 -ml -mt --cla_support=cla2 --float_support=fpu64 --idiv_support=idiv0 --tmu_support=tmu0 -Ooff --include_path="C:/TI/work_space_ccs10.1/clb_empty" --include_path="C:/TI/work_space_ccs10.1/clb_empty/Peripherals/clb" --include_path="C:/TI/work_space_ccs10.1/clb_empty/device" --include_path="C:/TI/c2000_ware/C2000Ware_3_02_00_00/driverlib/f2838x/driverlib" --include_path="C:/TI/c2000_ware/C2000Ware_3_02_00_00/device_support/f2838x/common/include" --include_path="C:/TI/c2000_ware/C2000Ware_3_02_00_00/utilities/clb_tool/clb_syscfg/systemc/include" --include_path="C:/TI/ccs10.1/ccs/tools/compiler/ti-cgt-c2000_20.2.1.LTS/include" --define=DEBUG --define=CPU1 -g --diag_suppress=10063 --diag_warning=225 --diag_wrap=off --display_error_number --gen_func_subsections=on --abi=eabi --preproc_with_compile --preproc_dependency="syscfg/$(basename $(<F)).d_raw" --include_path="C:/TI/work_space_ccs10.1/clb_empty/Debug/syscfg" --obj_directory="syscfg" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
