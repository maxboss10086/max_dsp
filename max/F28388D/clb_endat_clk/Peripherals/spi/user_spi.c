...
//    spib_rx_interrupt_set();
    ...
    GPIO_setPadConfig(spi_b_clk_gpio, GPIO_PIN_TYPE_STD);
    ...
    GPIO_setPadConfig(spi_b_mosi_gpio, GPIO_PIN_TYPE_STD);//释放总线等待主机的信号
    ...
    GPIO_setPadConfig(spi_b_miso_gpio, GPIO_PIN_TYPE_STD);
    ...
    SPI_setFIFOInterruptLevel(SPIB_BASE, (SPI_TxFIFOLevel)FIFO_LVL,//强转
